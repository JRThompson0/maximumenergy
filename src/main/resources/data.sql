...
INSERT INTO maxxenergysite.roles (role_Name)
SELECT 'ROLE_ADMIN'
WHERE NOT EXISTS (
    SELECT 1 FROM maxxenergysite.roles WHERE role_Name = 'ROLE_ADMIN'
);
...
WHERE NOT EXISTS (
    SELECT 1 FROM maxxenergysite.roles WHERE role_Name = 'ROLE_EMPLOYEE'
);
...
SELECT 'ROLE_USER'
WHERE NOT EXISTS (
    SELECT 1 FROM maxxenergysite.roles WHERE role_Name = 'ROLE_USER'
);
